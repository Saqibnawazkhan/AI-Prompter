...
import { imageTemplates, ImageTemplate } from '@/data/imageTemplates';
import { ImageFormData } from '@/types';

interface ImageTemplateSelectorProps {
  onSelectTemplate: (data: Partial<ImageFormData>) => void;
  onSkip: () => void;
  onBack: () => void;
}

export default function ImageTemplateSelector({
  onSelectTemplate,
  onSkip,
  onBack,
